...
const SessionSettingsPage: React.FC = () => {
  ...
  const [selectionMode, setSelectionMode] = useState<
    "random" | "weighted" | "ordered"
  >("weighted");
  const [settingInfo, setSettingInfo] = useState<Setting | null>(null);

  const handleReset = () => {
    // Here you would typically reset the settings to default
    const session_info: SessionInfo = localStorage.getItem("session_info")
      ? JSON.parse(localStorage.getItem("session_info") as string)
      : null;
    ...
    if (settings) {
      ...
      setMomentumType(
        settings.momentum_type as "intermixed" | "suggested" | "multiple"
      );
      setNumProbes(settings.num_probes.toString());
      setCorrectionTrials(settings.num_correction_trials.toString());
      setSelectionMode(
        settings.selection_mode as "random" | "weighted" | "ordered"
      );
              ...
              <div className="w-1/2 bg-white rounded-lg p-1 space-y-6 m-4">
                <div className="bg-white rounded-lg p-10 space-y-6">
                  <div className="text-sm text-gray-600 italic">
                    *Changing these settings will only affect this device.
                    Overall student settings will not change
                  </div>
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <label className="flex items-center gap-3 cursor-pointer">
                      ...
                      <span className="text-gray-700">
                        Apply Settings to every Session with this Student
                      </span>
                    </label>
                  </div>
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="relative">
                        ...
                        >
                          <option value="target">
                            After Each Scored Target
                          </option>
                          <option value="program">
                            After Session Completion(sticky Programs)
                          </option>
                        </select>
